...
const INFRA_SERVICES = [
  { host: "tailscale", name: "Alpha", desc: "VPN tunnel to homelab", label: "100.94.173.108" },
  { host: "tailscale2", name: "Emergency", desc: "VPN tunnel to emergency node", label: "100.110.39.105" },
];
